"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[9867],{"./packages/section/Section.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Basic:()=>Basic,HeaderDecorator:()=>HeaderDecorator,HeaderStyleOverride:()=>HeaderStyleOverride,default:()=>Section_stories});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),block=__webpack_require__("./packages/block/index.ts"),react=__webpack_require__("./node_modules/react/index.js");const SectionStyle=styled_components_browser_esm.ZP.section`
  margin: ${({theme})=>theme.spaceMap.xxl}px 0;
`,SectionHeaderStyle=styled_components_browser_esm.ZP.div`
  display: flex;
  align-items: flex-end;
  margin-bottom: ${({theme})=>theme.fontSizesMap.xxs}px;
`,SectionTitleStyle=styled_components_browser_esm.ZP.h2`
  margin-right: auto;
  font-weight: 800;
  font-size: ${({theme})=>theme.fontSizesMap.md}px;
  line-height: 1.3em;
`,SectionHeaderDecoratorStyle=styled_components_browser_esm.ZP.div`
  margin-left: ${({theme})=>theme.spaceMap.lg}px;
  font-size: ${({theme})=>theme.fontSizesMap.xxs}px;
  line-height: 1.5em;
`;function Section({title,headerDecorator,children,...rest},ref){return(0,jsx_runtime.jsxs)(SectionStyle,{...rest,ref,children:[title&&(0,jsx_runtime.jsxs)(SectionHeaderStyle,{children:[(0,jsx_runtime.jsx)(SectionTitleStyle,{children:title}),headerDecorator&&(0,jsx_runtime.jsx)(SectionHeaderDecoratorStyle,{children:headerDecorator})]}),children]})}const section_Section=(0,react.forwardRef)(Section);var ref,ref1,ref2,ref3,ref4,ref5,ref6,ref7,ref8;const Section_stories={component:section_Section,title:"Layout/Section",args:{title:"Section"}},Basic=props=>(0,jsx_runtime.jsx)(section_Section,{...props,children:(0,jsx_runtime.jsx)(block.gO,{children:"Example content"})}),HeaderDecorator=props=>(0,jsx_runtime.jsx)(section_Section,{...props,headerDecorator:(0,jsx_runtime.jsx)("a",{href:"https://lido.fi/",target:"_blank",rel:"noreferrer",children:"Lido link"}),children:(0,jsx_runtime.jsx)(block.gO,{children:"Example content"})}),H2OverrideStyled=styled_components_browser_esm.ZP.div`
  h2 {
    margin: 0 auto 0 0;
    padding: 0;
    font-weight: 800;
