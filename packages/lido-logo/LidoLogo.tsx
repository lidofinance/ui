...
import styles from './LidoLogo.module.css'

export type LidoLogoProps = Omit<ComponentPropsWithoutRef<'div'>, 'children'>

export const LidoLogo = forwardRef(
  (
    { className, ...rest }: LidoLogoProps,
    ref?: ForwardedRef<HTMLDivElement>,
  ) => {
    return (
      <div className={cn(styles.logo, className)} {...rest} ref={ref}>
        <svg
          width='89'
          height='20'
          fill='currentColor'
