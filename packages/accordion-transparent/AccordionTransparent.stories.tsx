...
export default {
  ...
  title: 'Layout/AccordionTransparent',
} as Meta

export const Basic: StoryFn<AccordionTransparentProps> = (
  props: AccordionTransparentProps,
) => (
  <AccordionTransparent {...props}>
...
Basic.argTypes = {
  defaultExpanded: {
    description: 'AccordionTransparent default state',
  },
  summary: {
