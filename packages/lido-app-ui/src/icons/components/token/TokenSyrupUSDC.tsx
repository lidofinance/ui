...
export const TokenSyrupUSDC = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      <path
        d='M0 12C0 5.373 5.373 0 12 0c6.628 0 12 5.373 12 12 0 6.628-5.372 12-12 12-6.627 0-12-5.372-12-12z'
        fill='#FC7A4A'
      />
      <path
