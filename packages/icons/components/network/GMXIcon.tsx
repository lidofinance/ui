...
export const GMXIcon = React.forwardRef(function GMXIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath='url(#GMXIcon__GMXIcon__a)'>
        <path
          fill='url(#GMXIcon__GMXIcon__b)'
          d='M65 57.998L40.038 21 15 57.998h34.884l-9.846-14.12-4.884 7.337h-5.19l10.078-14.752L54.61 58 65 57.998z'
        />
        <g filter='url(#GMXIcon__GMXIcon__c)' opacity={0.7}>
          <path
            fill='url(#GMXIcon__GMXIcon__d)'
      ...
      <defs>
        ...
        <clipPath id='GMXIcon__GMXIcon__a'>
          <path fill='#fff' d='M0 0h80v80H0z' />
        </clipPath>
        <filter
          id='GMXIcon__GMXIcon__c'
          width={82}
          height={69}
          x={2}
          y={0}
