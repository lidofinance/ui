    ...
    >
      <g clipPath='url(#SeamlessIcon__SeamlessIcon__a)'>
        <path
          ...
          clipRule='evenodd'
        />
        <g filter='url(#SeamlessIcon__SeamlessIcon__c)'>
          <path
            fill='url(#SeamlessIcon__SeamlessIcon__d)'
            fillRule='evenodd'
      ...
      <defs>
        <radialGradient
          id='SeamlessIcon__SeamlessIcon__b'
          cx={0}
          cy={0}
          r={1}
          gradientTransform='rotate(71.737 1.147 24.888) scale(63.1826)'
        ...
        <radialGradient
          id='SeamlessIcon__SeamlessIcon__d'
          cx={0}
          cy={0}
          r={1}
          gradientTransform='rotate(71.737 6.604 25.154) scale(63.1826)'
          gradientUnits='userSpaceOnUse'
        >
          <stop stopColor='#FFBFFF' />
          <stop offset={1} stopColor='#4F68F7' />
        </radialGradient>
        <clipPath id='SeamlessIcon__SeamlessIcon__a'>
          <path fill='#fff' d='M.022 0h80.004v80H.022z' />
        </clipPath>
        <filter
          id='SeamlessIcon__SeamlessIcon__c'
          width={76}
          height={76}
          x={6.022}
          y={-3}
        ...
        >
          ...
          <feGaussianBlur
            result='effect1_foregroundBlur_52_25160'
            stdDeviation={7}
          />
        </filter>
      </defs>
