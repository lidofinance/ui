...
export const InfStonesIcon = React.forwardRef(function InfStonesIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath='url(#InfStonesIcon__InfStonesIcon__a)'>
        <g
          filter='url(#InfStonesIcon__InfStonesIcon__b)'
          fill='#EDB500'
          fillOpacity={0.6}
        >
      ...
      <defs>
        <clipPath id='InfStonesIcon__InfStonesIcon__a'>
          <path fill='#fff' d='M0 0h80v80H0z' />
        </clipPath>
        <filter
          id='InfStonesIcon__InfStonesIcon__b'
          width={71.353}
          height={72}
          x={5}
          y={-2}
