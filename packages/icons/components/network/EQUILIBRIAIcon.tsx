...
export const EQUILIBRIAIcon = React.forwardRef(function EQUILIBRIAIcon(
  ...
  return (
    ...
    >
      ...
      />
      <g filter='url(#EQUILIBRIAIcon__EQUILIBRIAIcon__a)'>
        <path
          fill='#85FC4D'
          fillOpacity={0.6}
      ...
      <defs>
        <filter
          id='EQUILIBRIAIcon__EQUILIBRIAIcon__a'
          width={71}
          height={71.001}
          x={5.011}
          y={1.999}
