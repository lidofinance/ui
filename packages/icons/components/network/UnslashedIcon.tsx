...
export const UnslashedIcon = React.forwardRef(function UnslashedIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g filter='url(#UnslashedIcon__UnslashedIcon__a)' opacity={0.25}>
        <path
          fill='#01F496'
          fillRule='evenodd'
      ...
      <defs>
        <filter
          id='UnslashedIcon__UnslashedIcon__a'
          width={61}
          height={65}
          x={17}
          y={3}
