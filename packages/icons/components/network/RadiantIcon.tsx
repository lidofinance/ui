...
export const RadiantIcon = React.forwardRef(function RadiantIcon(
  ...
  return (
    ...
    >
      ...
      />
      <g filter='url(#RadiantIcon__RadiantIcon__b)' opacity={0.7}>
        <path
          fill='url(#RadiantIcon__RadiantIcon__c)'
      ...
      <defs>
        <linearGradient
          id='RadiantIcon__RadiantIcon__a'
          x1={40}
          x2={40}
          y1={13.436}
          y2={66.605}
        ...
        <linearGradient
          id='RadiantIcon__RadiantIcon__c'
          x1={45}
          x2={45}
          y1={11.436}
          y2={64.605}
        ...
        <filter
          id='RadiantIcon__RadiantIcon__b'
          width={70}
          height={70}
          x={10}
          y={3}
