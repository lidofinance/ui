...
export const PencilsIcon = React.forwardRef(function PencilsIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath='url(#PencilsIcon__PencilsIcon__a)'>
        <path
          fill='#CDF459'
      ...
      <g
        clipPath='url(#PencilsIcon__PencilsIcon__b)'
        filter='url(#PencilsIcon__PencilsIcon__c)'
      >
        <path
          fill='#CDF459'
          fillOpacity={0.6}
      ...
      <defs>
        <clipPath id='PencilsIcon__PencilsIcon__a'>
          <path fill='#fff' d='M23 21.996h35v36H23z' />
        </clipPath>
        <clipPath id='PencilsIcon__PencilsIcon__b'>
          <path fill='#fff' d='M23 18.996h35v36H23z' />
        </clipPath>
        <filter
          id='PencilsIcon__PencilsIcon__c'
          width={57}
          height={58}
          x={12}
          y={7.996}
