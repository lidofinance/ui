...
export const AlexarIcon = React.forwardRef(function AlexarIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g filter='url(#AlexarIcon__AlexarIcon__a)' opacity={0.2}>
        <path
          fill='#000'
      ...
      <g
        clipPath='url(#AlexarIcon__AlexarIcon__b)'
        filter='url(#AlexarIcon__AlexarIcon__c)'
      >
        <path
          fill='url(#AlexarIcon__AlexarIcon__d)'
      ...
      <g
        clipPath='url(#AlexarIcon__AlexarIcon__e)'
        filter='url(#AlexarIcon__AlexarIcon__f)'
        opacity={0.5}
      >
        <g filter='url(#AlexarIcon__AlexarIcon__g)'>
          <path
            fill='url(#AlexarIcon__AlexarIcon__h)'
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result='effect1_foregroundBlur_52_17189'
            stdDeviation={3}
          />
        </filter>
        <filter
          id='AlexarIcon__AlexarIcon__c'
          width={51.964}
          height={51.964}
          x={14.066}
          y={14.018}
        ...
        >
          ...
          <feBlend
            ...
            result='effect1_dropShadow_52_17189'
          />
          <feBlend
            in='SourceGraphic'
            in2='effect1_dropShadow_52_17189'
            result='shape'
          />
        </filter>
        <filter
          id='AlexarIcon__AlexarIcon__f'
          width={74}
          height={74}
          x={3.048}
          y={0}
        ...
        <clipPath id='AlexarIcon__AlexarIcon__b'>
          <path fill='#fff' d='M17.048 17h46v46h-46z' />
        </clipPath>
        <clipPath id='AlexarIcon__AlexarIcon__e'>
