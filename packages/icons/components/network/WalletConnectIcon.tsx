...
export const WalletConnectIcon = React.forwardRef(function WalletConnectIcon(
  ...
  return (
    ...
    >
      ...
      <path
        fill='#5194F7'
        d='M26.212 31.275c7.34-7.033 19.237-7.033 26.576 0l.883.847a.885.885 0 01.275.637.868.868 0 01-.276.637l-3.02 2.896a.483.483 0 01-.665 0l-1.215-1.166c-5.12-4.906-13.42-4.906-18.54 0l-1.301 1.248a.483.483 0 01-.664 0l-3.023-2.897a.885.885 0 01-.274-.636.872.872 0 01.274-.636l.97-.93zm32.825 5.99l2.688 2.577a.887.887 0 01.275.636.872.872 0 01-.275.637L49.6 52.736a.966.966 0 01-1.328 0l-8.606-8.247a.242.242 0 00-.332 0l-8.605 8.247a.965.965 0 01-1.329 0L17.275 41.115a.886.886 0 01-.275-.637.872.872 0 01.275-.637l2.69-2.578a.965.965 0 011.328 0l8.606 8.25c.09.087.24.087.332 0l8.605-8.248a.966.966 0 011.328 0l8.606 8.247c.092.088.24.088.332 0l8.605-8.248a.967.967 0 011.33 0z'
      />
      <defs>
        <filter
          id='WalletConnectIcon__WalletConnectIcon__a'
          width={73}
          height={55}
          x={7}
          y={7}
        ...
        >
          ...
          <feGaussianBlur
            result='effect1_foregroundBlur_52_25590'
            stdDeviation={6.5}
          />
        </filter>
      </defs>
