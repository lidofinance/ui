...
export const SandclockIcon = React.forwardRef(function SandclockIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath='url(#SandclockIcon__SandclockIcon__a)'>
        <path
          fill='#01FF97'
        ...
        />
        <g filter='url(#SandclockIcon__SandclockIcon__b)' opacity={0.6}>
          <path
            fill='#01FF97'
      ...
      <defs>
        <clipPath id='SandclockIcon__SandclockIcon__a'>
          <path fill='#fff' d='M.018 0h80v80h-80z' />
        </clipPath>
        <filter
          id='SandclockIcon__SandclockIcon__b'
          width={84}
          height={58}
          x={1.003}
          y={8.996}
