...
export const BingxIcon = React.forwardRef(function BingxIcon(
  ...
  return (
    ...
    >
      ...
      />
      <g filter='url(#BingxIcon__BingxIcon__b)' opacity={0.4}>
        <path
          fill='url(#BingxIcon__BingxIcon__c)'
        ...
        <path
          fill='#2A54FF'
          d='M60.009 41.127c-6.031 0-11.602-2.82-15.17-7.696-1.474-2.181-2.733-4.529-4.578-6.453-5.151-5.713-12.705-9.065-20.419-9.031v8.78c6.68-.034 12.886 3.56 16.245 9.334a27.629 27.629 0 003.51 4.823c5.157 5.71 12.704 9.068 20.418 9.04l-.006-8.794v-.004z'
        />
      </g>
      <defs>
        <linearGradient
          id='BingxIcon__BingxIcon__a'
          x1={22.462}
          x2={57.538}
          y1={52.577}
          y2={26.731}
        ...
        >
          <stop stopColor='#2A54FF' />
          <stop offset={0.52} stopColor='#2143CB' />
          <stop offset={1} stopColor='#2A54FF' />
        </linearGradient>
        <linearGradient
          id='BingxIcon__BingxIcon__c'
          x1={22.462}
          x2={57.538}
          y1={46.783}
          y2={20.937}
        ...
        >
          ...
          <feGaussianBlur
            result='effect1_foregroundBlur_52_17429'
            stdDeviation={7}
          />
        </filter>
      </defs>
