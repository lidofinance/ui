...
export const ConsensysIcon = React.forwardRef(function ConsensysIcon(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath='url(#ConsensysIcon__ConsensysIcon__a)'>
        <g filter='url(#ConsensysIcon__ConsensysIcon__b)' opacity={0.6}>
          <path
            fill='#CEFD54'
            fillRule='evenodd'
      ...
      <defs>
        <clipPath id='ConsensysIcon__ConsensysIcon__a'>
          <path fill='#fff' d='M.022 0h80v80h-80z' />
        </clipPath>
        <filter
          id='ConsensysIcon__ConsensysIcon__b'
          width={81}
          height={80}
          x={5.022}
          y={-7}
