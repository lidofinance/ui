    ...
    <svg width={200} height={84} viewBox='0 0 200 84' fill='none' {...props}>
      ...
      <defs>
        ...
        >
          ...
          <stop offset={0.08} stopOpacity={0.35} stopColor='currentColor' />
          <stop offset={0.16} stopOpacity={0.52} stopColor='currentColor' />
          <stop offset={0.42} stopOpacity={0.57} stopColor='currentColor' />
