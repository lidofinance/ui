...
export const Ambire = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width={81} height={80} viewBox='0 0 81 80' fill='none' {...props}>
      <g filter='url(#Ambire__a)' opacity={0.5}>
        <path
          fill='#6000FF'
          fillRule='evenodd'
        ...
        <g opacity={0.4}>
          ...
          <g opacity={0.4}>
            ...
            <g mask='url(#Ambire__b)'>
              <path
                fill='url(#Ambire__Ambire__h)'
      ...
      <g opacity={0.5}>
        ...
        <g mask='url(#Ambire__d)'>
          <path
            fill='url(#Ambire__Ambire__n)'
      ...
      <g opacity={0.4}>
        ...
        <g opacity={0.4}>
          ...
          <g mask='url(#Ambire__c)'>
            <path
              fill='url(#Ambire__Ambire__r)'
      ...
      <defs>
        ...
        <pattern
          id='Ambire__Ambire__d'
          width={1}
          height={1}
          patternContentUnits='objectBoundingBox'
        >
          <use href='#Ambire__Ambire__v' transform='scale(.0069 .00435)' />
        </pattern>
        <pattern
          id='Ambire__Ambire__h'
          width={1}
          height={1}
          patternContentUnits='objectBoundingBox'
        >
          <use href='#Ambire__Ambire__w' transform='scale(.00562 .00746)' />
        </pattern>
        <pattern
          id='Ambire__Ambire__n'
          width={1}
          height={1}
          patternContentUnits='objectBoundingBox'
        >
