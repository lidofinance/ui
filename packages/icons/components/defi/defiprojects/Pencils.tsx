...
export const Pencils = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width={81} height={80} viewBox='0 0 81 80' fill='none' {...props}>
      <g clipPath='url(#Pencils__Pencils__a)'>
        <path
          fill='#CDF459'
      ...
      <g
        clipPath='url(#Pencils__Pencils__b)'
        filter='url(#Pencils__Pencils__c)'
      >
        <path
          fill='#CDF459'
          fillOpacity={0.6}
      ...
      <defs>
        <clipPath id='Pencils__Pencils__a'>
          <path fill='#fff' d='M23 21.996h35v36H23z' />
        </clipPath>
        <clipPath id='Pencils__Pencils__b'>
          <path fill='#fff' d='M23 18.996h35v36H23z' />
        </clipPath>
        <filter
          id='Pencils__Pencils__c'
          width={57}
          height={58}
          x={12}
          y={7.996}
