...
export const Stakecat = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width={81} height={80} viewBox='0 0 81 80' fill='none' {...props}>
      <g filter='url(#Stakecat__Stakecat__a)'>
        <path
          fill='#8DC444'
      ...
      />
      <g filter='url(#Stakecat__Stakecat__b)'>
        <path
          fill='#F3BB27'
