...
`,InputGroup=(0,react.forwardRef)((({fullwidth=!1,error,success,children,...rest},ref)=>{const hasError=!!error,hasSuccess=!!success&&!error;return(0,jsx_runtime.jsxs)(InputGroupStyle,{$fullwidth:fullwidth,...rest,ref,children:[(0,jsx_runtime.jsx)(InputGroupContentStyle,{children}),hasError&&(0,jsx_runtime.jsx)(InputMessageStyle,{$variant:"error",children:error}),hasSuccess&&(0,jsx_runtime.jsx)(InputMessageStyle,{$variant:"success",children:success})]})}));InputGroup.displayName="InputGroup";const RangeInputSlider=styled_components_browser_esm.ZP.input`
  width: 100%;
