"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[2945],{"./packages/toast/Toast.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Basic:()=>Basic,Error:()=>Error,Info:()=>Info,Pending:()=>Pending,Success:()=>Success,default:()=>Toast_stories});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),packages_button=__webpack_require__("./packages/button/index.ts"),accordion=__webpack_require__("./packages/accordion/index.ts"),react_toastify_esm=__webpack_require__("./node_modules/react-toastify/dist/react-toastify.esm.js"),styled_components_wrapper=__webpack_require__("./packages/utils/styled-components-wrapper.ts");const ToastContainer=(0,styled_components_wrapper.ZP)(react_toastify_esm.Ix).attrs({draggable:!1})`
  /* Animations */
...
`,TOASTS_DEFAULT_OPTIONS={position:react_toastify_esm.Am.POSITION.BOTTOM_LEFT,closeButton:!1,hideProgressBar:!1,pauseOnHover:!0,pauseOnFocusLoss:!0,closeOnClick:!1,autoClose:6e3,delay:0},TOASTS_ERROR_OPTIONS={...TOASTS_DEFAULT_OPTIONS,closeOnClick:!0},TOASTS_SUCCESS_OPTIONS={...TOASTS_DEFAULT_OPTIONS},TOASTS_INFO_OPTIONS={...TOASTS_DEFAULT_OPTIONS,closeOnClick:!0},TOASTS_PENDING_OPTIONS={...TOASTS_DEFAULT_OPTIONS,autoClose:!1};var loaders=__webpack_require__("./packages/loaders/index.ts");const ToastPendingStyle=styled_components_wrapper.ZP.div`
  display: flex;
  align-items: center;
`,ToastPendingTextStyle=styled_components_wrapper.ZP.div``,ToastPendingLoaderStyle=(0,styled_components_wrapper.ZP)(loaders.aN)`
...
`,AccordionTitleStyle=styled_components_wrapper.ZP.div`
  color: var(--lido-color-text);
  flex-grow: 1;
  font-weight: 800;
  font-size: ${({theme})=>theme.fontSizesMap.xs}px;
  line-height: 1.6em;
`,AccordionArrowStyle=(0,styled_components_wrapper.ZP)(icons.ArrowBottom)`
  flex-shrink: 0;
...
`,AccordionContentStyle=styled_components_wrapper.ZP.div`
