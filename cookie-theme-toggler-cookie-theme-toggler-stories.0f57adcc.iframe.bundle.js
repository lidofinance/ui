"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[7885],{"./packages/cookie-theme-toggler/cookie-theme-toggler.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Providers:()=>Providers,default:()=>cookie_theme_toggler_stories});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),block=__webpack_require__("./packages/block/index.ts"),content_theme=__webpack_require__("./packages/content-theme/index.ts"),packages_text=__webpack_require__("./packages/text/index.ts"),styled_components_wrapper=__webpack_require__("./packages/utils/styled-components-wrapper.ts"),packages_button=__webpack_require__("./packages/button/index.ts"),icons=__webpack_require__("./packages/icons/index.tsx");const CookieThemeTogglerStyle=(0,styled_components_wrapper.ZP)(packages_button.zx).attrs({variant:"text",size:"xs"})`
  display: inline-grid;
