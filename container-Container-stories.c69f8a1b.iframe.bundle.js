"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[9205],{"./packages/container/Container.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Base:()=>Base,PageLayout:()=>PageLayout,default:()=>Container_stories});var ContainerSize,jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");!function(ContainerSize){ContainerSize[ContainerSize.full=0]="full",ContainerSize[ContainerSize.content=1]="content",ContainerSize[ContainerSize.tight=2]="tight"}(ContainerSize||(ContainerSize={}));var react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const sizes={full:styled_components_browser_esm.iv`
  ...
  ${({$size})=>sizes[$size]}
`;function Container({size="full",...rest},ref){return(0,jsx_runtime.jsx)(ContainerStyle,{$size:size,ref,...rest})}const container_Container=(0,react.forwardRef)(Container);var ref,ref1,ref2,ref3,ref4,ref5;const Container_stories={component:container_Container,title:"Layout/Container",parameters:{layout:"fullscreen"}},StyledDiv=styled_components_browser_esm.ZP.div`
  height: 100px;
