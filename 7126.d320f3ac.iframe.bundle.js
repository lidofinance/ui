"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[7126],{"./packages/input/index.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{II:()=>Input,Sl:()=>InputColor,BZ:()=>InputGroup,n$:()=>InputType,Jf:()=>InputVariant,zl:()=>OptionsSlider,a:()=>SliderInput,gx:()=>Textarea});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const colors={default:styled_components_browser_esm.iv`
    color: var(--lido-color-textSecondary);
  `,accent:styled_components_browser_esm.iv`
    color: var(--lido-color-accentContrastSecondary);
  `},labelEmptyValueCSS=styled_components_browser_esm.iv`
  ${({$color})=>colors[$color]}

  transform: scale(1);
  opacity: 0.5;
`,labelFilledValueCSS=styled_components_browser_esm.iv`
  ${({$color})=>colors[$color]}

  transform: translateY(-14px) scale(0.75);
  opacity: 1;
`,labelFocusCSS=styled_components_browser_esm.iv`
  color: var(--lido-color-primary);
  opacity: 1;
`,labelErrorCSS=styled_components_browser_esm.iv`
  color: var(--lido-color-error);
`,labelWarningCSS=styled_components_browser_esm.iv`
  color: var(--lido-color-warning);
`,InputLabelStyle=styled_components_browser_esm.ZP.span`
  position: absolute;
  left: 0;
  top: 50%;
  font-size: 1em;
  ...
  ${labelFilledValueCSS};
`,TextareaLabelStyle=(0,styled_components_browser_esm.ZP)(InputLabelStyle)`
  top: 10px;
`,statesCSS=styled_components_browser_esm.iv`
  &:hover {
    z-index: 1;
  }
...
`,activeCSS=styled_components_browser_esm.iv`
  &,
  &:hover,
  &:focus-within {
    z-index: 2;
...
`,errorCSS=styled_components_browser_esm.iv`
  &,
  &:hover,
  &:focus-within {
...
`,warningCSS=styled_components_browser_esm.iv`
  &,
  &:hover,
  &:focus-within {
...
`,wrapperColors={default:styled_components_browser_esm.iv`
  ...
  `},decoratorCSS=styled_components_browser_esm.iv`
  flex-grow: 0;
  flex-shrink: 0;
  cursor: inherit;
  display: flex;
  align-items: center;
`,InputLeftDecoratorStyle=styled_components_browser_esm.ZP.span`
  ${decoratorCSS}
  padding-right: 16px;
`,InputRightDecoratorStyle=styled_components_browser_esm.ZP.span`
  ${decoratorCSS}
  padding-left: 16px;
`,InputWrapperStyle=styled_components_browser_esm.ZP.label`
  position: relative;
  display: inline-flex;
  align-items: stretch;
...
`,contentVariants={default:styled_components_browser_esm.iv`
    padding-top: 17px;
    padding-bottom: 17px;
  ...
  `},InputContentStyle=styled_components_browser_esm.ZP.span`
  position: relative;
  display: flex;
  flex-grow: 1;
  padding-left: 15px;
...
`,InputControlWrapperStyle=styled_components_browser_esm.ZP.div`
  position: relative;
  display: flex;
  flex-grow: 1;
`,labeledCSS=styled_components_browser_esm.iv`
...
`,inputColors={default:styled_components_browser_esm.iv`
    color: var(--lido-color-text);
  ...
  `},InputStyle=styled_components_browser_esm.ZP.input`
  width: 100%;
  font-family: inherit;
  font-weight: 400;
  font-size: 1em;
...
`,TextareaStyle=(0,styled_components_browser_esm.ZP)(InputStyle).attrs({as:"textarea"})`
  resize: none;
`,messageVariants={error:styled_components_browser_esm.iv`
  ...
  `,warning:styled_components_browser_esm.iv`
    ...
    box-shadow: ${({theme})=>theme.boxShadows.sm}
      var(--lido-color-shadowLight);
  `,success:styled_components_browser_esm.iv`
    background: var(--lido-color-success);
    color: var(--lido-color-successContrast);
    box-shadow: ${({theme})=>theme.boxShadows.sm}
      var(--lido-color-shadowLight);
  `},InputMessageStyle=styled_components_browser_esm.ZP.span`
...
`,InputGroup=(0,react.forwardRef)((({fullwidth=!1,error,success,children,...rest},ref)=>{const hasError=!!error,hasSuccess=!!success&&!error;return(0,jsx_runtime.jsxs)(InputGroupStyle,{$fullwidth:fullwidth,...rest,ref,children:[(0,jsx_runtime.jsx)(InputGroupContentStyle,{children}),hasError&&(0,jsx_runtime.jsx)(InputMessageStyle,{$variant:"error",children:error}),hasSuccess&&(0,jsx_runtime.jsx)(InputMessageStyle,{$variant:"success",children:success})]})}));InputGroup.displayName="InputGroup";const RangeInputSlider=styled_components_browser_esm.ZP.input.attrs({type:"range"})`
  width: 100%;
