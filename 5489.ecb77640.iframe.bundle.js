...
`,variants={small:styled_components_browser_esm.iv`
    padding: 12px 0;
  ...
  `,default:styled_components_browser_esm.iv`
    ...
    line-height: 1.4em;
    font-weight: 400;
  `},PopupMenuItemContentStyle=styled_components_browser_esm.ZP.span`
  position: relative;
  padding: 18px 0;
  overflow: hidden;
...
`,decoratorCSS=styled_components_browser_esm.iv`
  ...
  display: flex;
  align-items: center;
`,PopupMenuItemLeftDecoratorStyle=styled_components_browser_esm.ZP.span`
  ${decoratorCSS};
  padding-right: 16px;
`,PopupMenuItemRightDecoratorStyle=styled_components_browser_esm.ZP.span`
  ${decoratorCSS};
  padding-left: 16px;
`,PopupMenuStyle=(0,styled_components_browser_esm.ZP)(popover.J2)`
  outline: none;
  box-sizing: border-box;
