"use strict";(self.webpackChunk_lidofinance_lido_ui=self.webpackChunk_lidofinance_lido_ui||[]).push([[9205],{"./packages/container/Container.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Base:()=>Base,PageLayout:()=>PageLayout,default:()=>Container_stories});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const sizes={full:styled_components_browser_esm.iv`
  ...
  ${({$size})=>sizes[$size]}
`,Container=(0,react.forwardRef)((({size="full",...rest},ref)=>(0,jsx_runtime.jsx)(ContainerStyle,{$size:size,ref,...rest})));var ContainerSize,ref,ref1,ref2,ref3,ref4,ref5;Container.displayName="Container",function(ContainerSize){ContainerSize[ContainerSize.full=0]="full",ContainerSize[ContainerSize.content=1]="content",ContainerSize[ContainerSize.tight=2]="tight"}(ContainerSize||(ContainerSize={}));const Container_stories={component:Container,title:"Layout/Container",parameters:{layout:"fullscreen"}},StyledDiv=styled_components_browser_esm.ZP.div`
  height: 100px;
